$(document).ready(function(){
	...
	function getOptions() {
		...
		var names = [ "Украины", "т.н. ДНР", "РФ", "Днепропетровской области", "Януковича", "Крыма", "трубы" ];
		var ofThe = [ "Украины", "т.н. ДНР", "РФ", "Днепропетровской области", "ЕС", "трубы", "интернета", "Русского Мира", "Крыма", "обстоятельств" ];
		var creations = [ "Провозглашение", "Похищение", "Оповещение", "Облучение", "Объявление", "Признание" ];
		var beingThe = [ "независимым государством", "наследником СССР", "агентом ЦРУ", "пособником терроризма", "невиновным" ];
